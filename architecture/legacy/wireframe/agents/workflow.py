...
from .nodes import parse_node, plan_node, extract_node, classify_node, save_node, extract_schematic_components_node
...
def build_extraction_workflow():
    ...
    workflow.add_node("extract_schematic_components", extract_schematic_components_node)
    ...
    workflow.add_edge("classify", "extract_schematic_components")
    workflow.add_edge("extract_schematic_components", "save")
